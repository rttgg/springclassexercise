...
public class UserControllerOne {
    ...
    /* This method is the variation of the above method. It will accept a model and save values
    in this model. These saved values will be available on the frontend to the custom  */

    @ModelAttribute
    public void getUsers(Model model) {
        User u1 = new User(1, "haseeb","haseeb@gmail.com");
        User u2 = new User(2, "Josph","josph@gmail.com");
        User u3 = new User(3,"Ameer", "ammer@gmail.com");
